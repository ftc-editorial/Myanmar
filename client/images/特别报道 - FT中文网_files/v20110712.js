...
(function (window, undefined) {
	...
	Player.prototype = {
		...
		getVideoCode: function (params, video) {
			...
			//} else {
                ...
                function pcmCheck(){
                    ...
                    if(postf.substring(0,4) == '.pcm'){
                        videoCode = _this.crateFormat(params);
                    }
                };
		...
		crateFormat: function(params){
            return"<div style='width: 100%; background: #000; color: #fff; text-align: center; font-size: 18px;'>"
                   +"   <div style='line-height:" + params.height +"px;'>"
                   +"   <span style='font-size:18px'>"+decodeURIComponent('%E6%AD%A4%E8%A7%86%E9%A2%91%E5%B7%B2%E5%8A%A0%E5%AF%86%EF%BC%8C%E8%AF%B7%E5%9C%A8%E5%85%B6%E4%BB%96%E8%AE%BE%E5%A4%87%E4%B8%8A%E8%A7%82%E7%9C%8B')+"</span>"
                   +"   </div>"
                   +"</div>";
        },
		...
		html5PlayerSkin: function(params, video, ts){
			...
			CCHtml5Player.prototype = {
				...
				init: function(id){
					...
					this.addListener(this.oVideo, 'ended', function(){_this.exitFullscreen();});
